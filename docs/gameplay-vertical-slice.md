...
- AI 词汇教练必须把词典中的每个中文义项逐项解释，并在展开区按原义项顺序显示词性、释义、自然英文例句和所选语言翻译。语法或技术术语（例如 `perfect` 的名词义“完成时”）还必须说明概念、标准结构、适用场景和常见错误；多词性存在标准重音或发音变化时一并提醒。结构化例句缺少任一义项时，整次讲解视为不完整并允许重新生成。
